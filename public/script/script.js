...
//     fetch('/api/booking-details-form', {
//         method: 'POST',
...
//     document.getElementById('to-user')?.addEventListener('submit', () => {
//         navigateWithValidation(document.getElementById('booking-details-form'), '../public/user-form.php');
        
//     });
    
//     document.getElementById('back-home')?.addEventListener('click', () => {
//         navigateToPage('../public/index.php');
//         // navigateWithValidation(document.getElementById('booking-details-form'), '../public/index.html');
//     });
    
//     document.getElementById('back-booking')?.addEventListener('click', () => {
//         navigateWithValidation(document.getElementById('user-details-form'), '../public/booking-form.php');
//     });
    
//     document.getElementById('to-entered_details')?.addEventListener('click', () => {
//         navigateWithValidation(document.getElementById('user-details-form'), '../public/entered-form.php');
//     });
    

//     // Payment Navigation
//     handleCheckboxInteraction('accept-terms', 'to-payment', '../public/payment-form.php');
//     handleCheckboxInteraction('accept-terms', 'pay-later-to-home', '../public/index.php');
...
function two_wh(){
    document.getElementById('price_content').style.display='block';
}