...
<body>
            ...
            <main>
                <div class="grid-container">
                    ...
                    <div class="grid-item">
                        ...
                        <a href="../public/booking-form.php" onclick="two_wh()">Book</a>
                    </div>
                    <div class="grid-item">
    ...
    <script>
    function two_wh() {
        // Store price information in local storage
        localStorage.setItem("price", "500"); // Replace "500" with the appropriate value if needed
    }
    function four_wh() {
        // Store price information in local storage
        localStorage.setItem("price", "1200"); // Replace "500" with the appropriate value if needed
    }
    function hy_wh() {
        // Store price information in local storage
        localStorage.setItem("price", "1200"); // Replace "500" with the appropriate value if needed
    ...
    function ev_wh() {
        // Store price information in local storage
        localStorage.setItem("price", "1255"); // Replace "500" with the appropriate value if needed
    }
    function tr_wh() {
        // Store price information in local storage
        localStorage.setItem("price", "1000"); // Replace "500" with the appropriate value if needed
    }
